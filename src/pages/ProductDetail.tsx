      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            {product.images?.edges?.length > 1 && (
              <div className="grid grid-cols-4 gap-2">
                {product.images.edges.slice(1, 5).map((image: any, index: number) => (
                  <Card key={index} className="overflow-hidden cursor-pointer hover:border-foreground transition-all">
                    <img
                      src={image.node.url}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-serif text-foreground mb-2">{product.title}</h1>
