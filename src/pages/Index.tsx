    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="top-styles" className="py-20 bg-secondary/10">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center gap-4 mb-12 flex-wrap">
            <button className="px-6 py-2 border border-gold text-gold hover:bg-gold hover:text-background transition-all rounded-full">
              All
            </button>
            <button className="px-6 py-2 border border-border text-foreground hover:border-gold hover:text-gold transition-all rounded-full">
              Necklaces
            </button>
            <button className="px-6 py-2 border border-border text-foreground hover:border-gold hover:text-gold transition-all rounded-full">
              Rings
      ...
      <footer className="py-12 border-t border-border">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-serif text-gold mb-4">Aurora Cadence</h3>
